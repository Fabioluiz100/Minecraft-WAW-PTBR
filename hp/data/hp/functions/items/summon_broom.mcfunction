...
execute as @s[tag=notAllowedToFly,scores={lastRegion=2}] run title @s subtitle {"text":"Não é possível voar nesta área.","bold":false,"color":"red"}
execute as @s[tag=notAllowedToFly,scores={lastRegion=5..6}] run title @s subtitle {"text":"Não é possível voar nesta área.","bold":false,"color":"red"}
execute as @s[tag=notAllowedToFly,scores={lastRegion=8..9}] run title @s subtitle {"text":"Não é possível voar nesta área.","bold":false,"color":"red"}
execute as @s[tag=notAllowedToFly,scores={lastRegion=11}] run title @s subtitle {"text":"Não é possível voar nesta área.","bold":false,"color":"red"}

execute as @s[tag=notAllowedToFly,tag=!playerIsOutside,scores={lastRegion=1}] run title @s subtitle {"text":"Você não pode voar lá dentro.","bold":false,"color":"red"}
execute as @s[tag=notAllowedToFly,tag=!playerIsOutside,scores={lastRegion=3}] run title @s subtitle {"text":"Você não pode voar lá dentro.","bold":false,"color":"red"}
execute as @s[tag=notAllowedToFly,tag=!playerIsOutside,scores={lastRegion=4}] run title @s subtitle {"text":"Você não pode voar lá dentro.","bold":false,"color":"red"}
