...
execute as @s[scores={cutSceneTimer=200}] run title @s subtitle ["",{"text":"O Ministério da Magia","bold":true,"color":"gold"}]
execute as @s[scores={cutSceneTimer=200}] run title @s title {"text":"Viajar para","color":"gray"}
