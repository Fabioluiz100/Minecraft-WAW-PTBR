...
execute as @s[tag=!softExitMap,tag=!invInspectItem,tag=!preventDoubleExecution,tag=selectedDestinationLocked,scores={convState=1..}] run title @s subtitle {"text":"Você ainda não desbloqueou esse destino!","bold":false,"color":"red"}
# Start state
