...
replaceitem entity @s[scores={editPage=0}] hotbar.0 minecraft:endermite_spawn_egg{display:{Name:"{\"text\":\"Gerar Porta Alohomora\",\"color\":\"gold\",\"italic\":false}"},EntityTag:{NoAI:1b,Tags:["spawnAlohomoraDoor"]},qDetect:1b,altFDetect:1b}
replaceitem entity @s[scores={editPage=0}] hotbar.1 minecraft:endermite_spawn_egg{display:{Name:"{\"text\":\"Ponto de Geração de Criatura\",\"color\":\"gold\",\"italic\":false}"},EntityTag:{NoAI:1b,Tags:["spawnCreaturePoint"]},qDetect:1b,altFDetect:1b}
...
replaceitem entity @s hotbar.8 written_book{pages:["[\"\",{\"text\":\"\\n\"},{\"text\":\"- Adicionar itens\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/function hp:creation_tools/add_items\"}},{\"text\":\"\\n\\n\"},{\"text\":\"- Remover itens\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/function hp:creation_tools/remove_items\"}},{\"text\":\"\\n\\n\"},{\"text\":\"- Página 1\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @s editPage 0\"}},{\"text\":\"\\n\"},{\"text\":\"- Página 2\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @s editPage 1\"}},{\"text\":\"\\n\"},{\"text\":\"- Página 3\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @s editPage 2\"}},{\"text\":\"\\n- Página 4\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @s editPage 3\"}},{\"text\":\"\\n- Página 5\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @s editPage 4\"}},{\"text\":\"\\n\\n- Spawners \"},{\"text\":\"1 \",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @s editPage 10\"}},{\"text\":\"- 2 \",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @s editPage 11\"}},{\"text\":\"- 3 \",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @s editPage 12\"}},{\"text\":\"- 4 \",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/scoreboard players set @s editPage 13\"}}]"],title:Container,author:"ya boi",display:{Lore:["Edit items in containers"]},altFDetect:1b}
...
execute at @e[tag=spawnSmallChest] run summon minecraft:armor_stand ~ ~ ~ {Marker:1b,NoGravity:1b,Team:"NPC",CustomName:"{\"text\":\"Small Chestˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈ\",\"color\":\"dark_gray\"}",Invulnerable:1b,DisabledSlots:2039583,Invisible:1b,Tags:["chest","smallChest","interactable","glowable","restorable","smallChestBeingSpawned","resettable"],ArmorItems:[{},{},{},{id:"minecraft:wooden_sword",Count:1b,tag:{Unbreakable:1b,Damage:56}}],NoBasePlate:1b}
