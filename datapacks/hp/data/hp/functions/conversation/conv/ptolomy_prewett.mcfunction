...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Bem-vindo(a). A melhor seleção de mercadorias diversas do Beco Diagonal. Em que posso ajudá-lo(a)? \"}"}
