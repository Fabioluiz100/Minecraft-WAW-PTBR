...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Quer preparar algumas poções? Elas podem ser muito úteis em caso de necessidade. \",\"color\":\"white\",\"bold\":\"false\"}"}
