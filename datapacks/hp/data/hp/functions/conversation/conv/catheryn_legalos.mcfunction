...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Bem-vinda à Green Leaf, querida. Como posso ajudá-la? Trabalhamos principalmente com ervas e ingredientes alquímicos, esse tipo de coisa.\"}"}
