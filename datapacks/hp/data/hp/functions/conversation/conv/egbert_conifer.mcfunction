...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Erva-de-cão e cogumelo-da-morte. Poções e ingredientes para poções. O que você quer? \"}"}
