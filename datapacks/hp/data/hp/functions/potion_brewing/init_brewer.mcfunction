...
execute as @s[scores={playerID=1}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Tags:["initbrewerPlController","brewerPlControllerPlayer1"],CustomName:"{\"text\":\"plController\"}",UUID:[I;0,19,0,1]}
execute as @s[scores={playerID=2}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Tags:["initbrewerPlController","brewerPlControllerPlayer2"],CustomName:"{\"text\":\"plController\"}",UUID:[I;0,19,0,2]}
execute as @s[scores={playerID=3}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Tags:["initbrewerPlController","brewerPlControllerPlayer3"],CustomName:"{\"text\":\"plController\"}",UUID:[I;0,19,0,3]}
execute as @s[scores={playerID=4}] at @s run summon armor_stand ~ ~ ~ {Invulnerable:1b,Invisible:1b,Tags:["initbrewerPlController","brewerPlControllerPlayer4"],CustomName:"{\"text\":\"plController\"}",UUID:[I;0,19,0,4]}
