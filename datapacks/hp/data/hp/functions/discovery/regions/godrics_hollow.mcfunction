...
# On Discover
execute as @s[tag=!discovered_godrics_hollow,scores={playerID=1},tag=!inProperCutScene] run bossbar set minecraft:player1empty name {"text":"Descoberto","color":"white","italic":"true"}
execute as @s[tag=!discovered_godrics_hollow,scores={playerID=2},tag=!inProperCutScene] run bossbar set minecraft:player2empty name {"text":"Descoberto","color":"white","italic":"true"}
execute as @s[tag=!discovered_godrics_hollow,scores={playerID=3},tag=!inProperCutScene] run bossbar set minecraft:player3empty name {"text":"Descoberto","color":"white","italic":"true"}
execute as @s[tag=!discovered_godrics_hollow,scores={playerID=4},tag=!inProperCutScene] run bossbar set minecraft:player4empty name {"text":"Descoberto","color":"white","italic":"true"}
